...
public class String_LongestPalindrome {
    ...
    //manipulation.Solution 1: (easier but involves using data structure)
    ...
    public static void main(String[] args) {
        String_LongestPalindrome obj = new String_LongestPalindrome();
        System.out.println(obj.longestPalindrome1("radar racecar madam bbaaaaaaaaaabb"));
